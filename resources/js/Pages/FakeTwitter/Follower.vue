                ...
                <div class="container" style="border: 1px solid #ccc;border-radius: 4px;">
                    <div class="row">
                        <div class="col-md-8 offset-md-2 py-4">
                            <template v-if="followerInfo?.followers?.length !== 0">
                                <h5>Your follower list</h5>
                                <div class="card mt-4">
                                    <ul class="list-group list-group-flush">
                                        <li v-for="(item, index) in followerInfo.followers" :key="index" class="list-group-item">
                                            <div class="d-flex">
                                                ...
                                                <div style="margin-left: 10px">
                                                    <h5 class="mb-0">{{ item.follower.name }}</h5>
                                                    <small class="text-muted">{{ item.follower.date }}</small>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
...
<script setup>
    ...
    const getFollowers = () => {
        ...
        .then(res => {
            ...
            followerInfo.value = res.data.data;
        });
    };
